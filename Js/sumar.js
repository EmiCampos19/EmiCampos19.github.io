...
document.getElementById("calcularBtn2").addEventListener("click", restar);
...
document.getElementById("calcularBtn3").addEventListener("click", multiplicar);
...
document.getElementById("calcularBtn4").addEventListener("click", dividir);